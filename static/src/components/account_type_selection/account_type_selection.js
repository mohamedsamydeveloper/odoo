    ...
    get hierarchyOptions() {
        ...
        return [
            ...
            { name: _t('Expense'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
             { name: _t('non-current assets'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
             { name: _t('current liabilities'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
              { name: _t('current assets'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
             { name: _t('non-current liabilities'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
              { name: _t('Equity'), children: opts.filter(x => x[0] && x[0].startsWith('expense')) },
